...
function (_React$Component) {
  ...
  function ActionsProvider(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ActionsProvider).call(this, props));
  }
...
function withActions(WrappedComponent) {
  ...
  function (_React$Component2) {
    _inherits(WithActionsHOC, _React$Component2);

    function WithActionsHOC(props) {
      _classCallCheck(this, WithActionsHOC);

      return _possibleConstructorReturn(this, _getPrototypeOf(WithActionsHOC).call(this, props));
    }

    _createClass(WithActionsHOC, [{
      key: "render",
      value: function render() {
