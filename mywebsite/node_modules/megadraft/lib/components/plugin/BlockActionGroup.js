...
function (_Component) {
  ...
  function BlockActionGroup() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BlockActionGroup).apply(this, arguments));
  }

  _createClass(BlockActionGroup, [{
    key: "renderItem",
    value: function renderItem(item) {
      return _react["default"].createElement(_BlockAction["default"], {
        item: item,
        key: item.key
      });
    }
