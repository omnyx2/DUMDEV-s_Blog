...
function (_Component) {
  ...
  function CommonBlock(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CommonBlock).call(this, props));
  ...
  _createClass(CommonBlock, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_plugin.BlockWrapper, {
        readOnly: readOnly
      }, !readOnly && _react["default"].createElement(_plugin.BlockControls, null, _react["default"].createElement(_Dropdown["default"], {
        items: options.displayOptions,
        selected: data.display || options.defaultDisplay,
        onChange: this._handleDisplayChange
      }), _react["default"].createElement(_plugin.BlockActionGroup, {
